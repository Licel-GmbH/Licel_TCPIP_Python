...
class Licel_Netcdf_Wrapper():
    ...
    def __init__(self, filename, acessmode, device, numFFT, FFTSize, numTrig):
        self.filename = filename
        self.accesmode = acessmode
        self.numFFT = numFFT
    ...
    def createNetCDF_Wind_Structure(self) -> netCDF4.Dataset:
        ...
        we also add descirption for each variable.
        '''
        
        Dataset = netCDF4.Dataset(self.filename, self.accesmode, 'NETCDF4')
        ...
        # to conserve compatibilty with the labview viewer the name remains unchanged. 
    ...
    def fillAcquisitionInfo(self, max_distance, samplingRate_hz, targetShots,
        ...
        Frequency_increment = wind.calcFrequencyIncrement(samplingRate_hz, FFT_Size)
        self.max_distance[:] = max_distance
        self.range_resolution[:] = rangeRes
        self.time_resolution[:] = timeRes
        self.frequncy_increment[:] = Frequency_increment
    ...
    def fillTransientDataset(self) ->  netCDF4.Dataset: 
        ...
        print("Support for transiet Recorder NetCDF planned for the up " \
              "coming release ...")
        return Dataset
    ...
    def _createWaveriderVaraiables(self, Dataset):
        '''
        helper function to create variables structre holding the 
        waverider and acquistion information, including the Dataset structure.
        '''
    ...
    def createVarDescription(self): 
        ...
        self.waverider_version.long_description	= "Firmtware version of the waverider"
        ...
        self.station_alt.long_description	= "Altitude above sealevel of the wind lidar"
        ...
        self.pc_time_start.long_description	= "PC time correspondig to timestamp_start, seconds since 12:00 a.m. 1904-01-01 UTC"
        self.pc_time_start.C_format		= "%.8f"
        
        self.pc_time_read.units               = "Seconds" 
        self.pc_time_read.valid_range		= (0.0, 6185322000.0) 
        self.pc_time_read.long_description	= "PC time correspondig to the submission current record, seconds since 12:00 a.m. 1904-01-01 UTC"
    ...
    def time_unix_to_epoch_1904(self):
        ...
        #TODO convert time to numpy float64
        ''' 
    ...
    def saveNetcdf(self,CYCLE, powerSpectra: np.ndarray[np.uint64], timestamp, currentShots):
        '''
